...
function Main() {
  ...
  return (
    <main className="snap-y snap-mandatory h-screen overflow-y-scroll">
      ...
      <div className="min-h-screen snap-start w-screen p-4 md:p-8">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 w-full mx-auto">
            <div className="p-4 md:p-8 border border-black rounded-xl flex flex-col justify-start">
              <div className="h-12 w-12 bg-[url('../src/assets/transportation_logo.png')] bg-cover"></div>
              <h1 className="mt-4 text-xl font-medium" > Public Transportation </h1>
              <p className="mt-4 text-start text-sm">Access bus schedules, route maps, ticket information, and real time updates for all public transportation services</p>
            ...
            <div className="p-4 md:p-8 border border-black rounded-xl flex flex-col justify-start">
              <div className="h-12 w-12 bg-[url('../src/assets/images/amendment_logo.png')] bg-cover"></div>
              <h1 className="mt-4 text-xl font-medium">Latest Amendments</h1>
              <p className="mt-4 text-start text-sm">Stay updated with the latest legal amendments, policy changes, and regulatory updates affecting city residents.</p>
              <ul className="mt-4 list-inside list-disc text-sm">
      ...
      <div className="min-h-screen snap-start flex flex-col lg:flex-row gap-4 md:gap-8 mt-4 md:mt-10 p-4 md:p-8">
        <article className="flex flex-col flex-1 rounded-2xl bg-gray-100 shadow-lg">
          <div className="flex-1 overflow-auto">
            <img className="w-full h-full object-cover object-top rounded-t-2xl" src="https://placehold.co/800x600/374151/white?text=UN+Food+Summit" alt="UN Food Summit" />
          </div>
        ...
        <article className="flex flex-col flex-1 relative rounded-2xl bg-gray-100 shadow-lg">
          <div className="flex-1 overflow-auto">
            <img className="w-full h-full object-cover object-center rounded-t-2xl" src="https://placehold.co/800x600/374151/white?text=UN+Food+Summit+2" alt="UN Food Summit" />
          </div>
          <section className="flex-1 flex flex-col p-4 md:p-8">
            <h1 className="text-center font-bold text-xl md:text-2xl">UN Food Summit</h1>
            <p className="font-medium text-sm md:text-md mt-2">Ethiopia, with the help of Italy, will be hosting the upcoming UN food systems Summit. In connection with this conference, Prime Minister Abiy Ahmed (PhD) received and spoke to heads of institutions and leaders who arrived in Addis Ababa.<br />
